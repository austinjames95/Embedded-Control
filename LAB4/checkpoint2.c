...
int main() {    /** Main Function ****/
    ...
    while (1) {
        if (runControl) {
            ...
            potSteer = ADC14_getResult(ADC_MEM9);
            if (potSteer >= 16382)
            {
                potSteer = 16382;
            }
            ...
            {
                steerNorm = (potSteer - 10648.3)/5733.7;
                diffSpeed = steerNorm * diffMax;
            }
            else if (potSteer >= 0 && potSteer <= 5733.7)
            {
                steerNorm = (5733.7 - potSteer)/5733.3;
                diffSpeed = steerNorm * diffMax;
            }
            else
            {
